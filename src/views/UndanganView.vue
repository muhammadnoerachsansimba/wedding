<script setup lang="ts">
    ...
    onMounted(() => {
        // Play audio
        const audio = new Audio('/assets/audio/beautiful_in_white.mp3')
        audio.play()
...
<template>
    <div class="flex flex-col min-h-[100vh] py-5 bg-[#C9BEB7]">
        <div class="flex flex-col justify-center items-center px-10 py-5 w-100 md:w-10">
            <img src="../assets/images/married.svg" alt="" class="w-[70%] md:w-[20%]">
        </div>
        ...
        <div class="flex flex-col justify-center items-center px-10 py-10 gap-8">
            <div class="flex flex-col justify-center items-center w-100">
                <div class="flex flex-col w-52">
                    <h1 class="font-dancing font-bold text-6xl text-left text-[#9A6A2D]">Albert</h1>
